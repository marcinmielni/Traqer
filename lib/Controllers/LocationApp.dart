...
class _LocationAppState extends State<LocationApp> {
    ...
    Stream<Position> positionStream(Duration interval) {
      ...
      Future<void> tick(_) async {
        lastPosition = await getCurrentLocation();
    ...
    Widget build(BuildContext context) {
      ...
      Stream<Position> positionStr = positionStream(const Duration(seconds: 5));
      StreamSubscription<Position> subscription = positionStr.listen((event) { });
